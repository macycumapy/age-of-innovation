...
class BoardStateFactoryTest extends TestCase
{
    ...
    /** @param list<string> $waterHexIds */
    #[DataProvider('mapWaterHexes')]
    public function test_it_adds_water_hexes_to_map(MapVariant $variant, array $waterHexIds): void
    {
        $hexes = collect((new BoardStateFactory())->create($variant)->hexes)->keyBy('id');

        foreach ($waterHexIds as $waterHexId) {
            $this->assertSame(TerrainType::Water, $hexes->get($waterHexId)->terrain);
        }
    }
    ...
    {
        yield '1–3 игрока' => [MapVariant::OneToThreePlayers, 88];
        yield '3–5 игроков' => [MapVariant::ThreeToFivePlayers, 116];
    }

    /** @return iterable<string, array{MapVariant, list<string>}> */
    public static function mapWaterHexes(): iterable
    {
        yield '1–3 игрока' => [MapVariant::OneToThreePlayers, [
            '5:0', '5:1', '9:1', '4:2', '5:2', '7:2', '8:2', '3:3',
            '5:3', '6:3', '2:4', '2:5', '5:5', '2:6', '3:6', '4:6',
            '5:6', '6:6',
        ]];

        yield '3–5 игроков' => [MapVariant::ThreeToFivePlayers, [
            '1:0', '7:0', '1:1', '2:1', '7:1', '11:1', '2:2', '6:2',
            '7:2', '9:2', '10:2', '2:3', '5:3', '7:3', '8:3', '2:4',
            '3:4', '4:4', '-1:5', '0:5', '1:5', '4:5', '7:5', '-2:6',
            '1:6', '4:6', '5:6', '6:6', '7:6', '8:6', '0:7', '-1:8',
        ]];
    }
}
