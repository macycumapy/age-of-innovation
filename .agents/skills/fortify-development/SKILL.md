...
- **Actions**: Check `../../../app/Domain/Fortify/Actions/Fortify/` for customizable business logic (user creation, password validation, etc.)
...
Modify `../../../app/Domain/Fortify/Actions/CreateNewUser.php` to customize user creation logic, validation rules, and additional fields.
